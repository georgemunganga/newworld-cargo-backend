                            ...
                            <div class="user-profile-data">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="track-title">
                                                <h5 class="form_sub" style="background-color: #f7c600; border-radius: 3px; color:white">{{ __('cargo::view.Sender') }}</h5>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                ...
                                <div class="payment-wrap">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="track-title">
                                                <h5 class="form_sub"  style="background-color: #f7c600; border-radius: 3px; color:white">{{ __('cargo::view.recipient') }}</h5>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
