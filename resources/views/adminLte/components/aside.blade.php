<!--begin::Aside-->
<aside class="main-sidebar sidebar-dark-primary elevation-4" style="background-color: #012642; margin-bottom: 30px;">
    <!--begin::Brand-->
    <div class="aside-logo flex-column-auto brand-link" id="kt_aside_logo">
        ...
        @endphp
        <a href="{{ aurl('/') }}" style="display: flex;justify-content: flex-start; padding-left: 1rem;">
            <img src="{{ $model->getFirstMediaUrl('system_logo') ? $model->getFirstMediaUrl('system_logo') : asset('assets/lte/cargo-logo-white.svg') }}" alt="Logo" style="height: 58px;" class="logo" />
        </a>
        <!--end::Logo-->
    </div>
    <!--end::Brand-->
